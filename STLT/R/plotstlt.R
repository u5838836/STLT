...
plot.stlt=function(x,...){
  ...
  if (abs(gam)<0.001) {
    ...
    plot(X[1:(5400+1)],c(gompqx1,gompqx2,paretoqx),type="l",xlab="Age", ylab="qx",main="STLT plot", col='blue',ylim=c(0,1))
    ...
    if (gam<0) {
      ...
      plot(X[1:(5400+1)],c(gompqx1,gompqx2,paretoqx),type="l",col='red',main="STLT plot",ylim=c(0,1))
      points(x,qx[1:(which(is.na(qx))[1]-1)])
    }
  }
}
